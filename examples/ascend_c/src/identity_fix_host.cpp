// Host: ./ascend_identity_fix <N> <launchBlocks>
#include <iostream>
#include <vector>
#include <cmath>
#include <cstdint>
...
#include "acl/acl.h"
using half_t = __fp16;
extern "C" int aclrtlaunch_identity_fix_kernel(uint32_t, aclrtStream, void*, void*, void*, void*);
...
int main(int argc, char** argv) {
    ...
    int rc = aclrtlaunch_identity_fix_kernel(NBK, s, dx, dy, nullptr, dt);
    ...
    std::cout << "=== identity_fix N=" << N << " launchBlocks=" << NBK
