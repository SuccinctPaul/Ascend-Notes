...
![Cube 单元：一次 16×16 输出分块，fp16 输入、fp32 在 L0C 累加](/Ascend-Notes/cube-unit-16x16.png)
...
![TileLang GEMM 调度时序：DMA 搬运与 Cube 计算并行，barrier 负责同步](/Ascend-Notes/tilelang-gemm-schedule.png)
