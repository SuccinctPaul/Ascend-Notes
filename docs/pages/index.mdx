...
<HomePage.Root>
  <HomePage.Tagline>面向 0→1 新手的昇腾 Ascend NPU 知识库</HomePage.Tagline>
  <HomePage.Description>
    从硬件架构到 LLM 算子优化，从性能模型到 Profiling 实战——
    帮你一步步成长为专业的 NPU 开发者。
  </HomePage.Description>
  <HomePage.Buttons>
    <HomePage.Button href="/hardware/01-ai-core-overview" variant="accent">
      从硬件架构开始
    </HomePage.Button>
    <HomePage.Button href="/reference/context">
      术语表
    </HomePage.Button>
  </HomePage.Buttons>
</HomePage.Root>
